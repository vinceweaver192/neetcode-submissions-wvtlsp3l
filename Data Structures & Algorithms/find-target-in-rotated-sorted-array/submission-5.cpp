...
public:
    int search(vector<int>& nums, int target) {
        ...
        // *** GOTCHA ***
        //     - Be sure to include the left <= values TWICE,
        //       1. for the initial while loop
        //       2. for the first left inclusive conditional check
        // - Reasoning:
        //   o Since the constraint suggests that the list can have at least ONE value, the size
        //     can be atleast 1. Therefore, we need to be inclusive atleast once!
